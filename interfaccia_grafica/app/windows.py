...
def creation_window(locomotive_window,GUI):
    ...
    loco_id_label.pack()
    loco_id_entry = tk.Entry(locomotive_window)
    loco_id_entry.pack()
...
def remove_window(locomotive_window,GUI):
    ...
    ID_label.pack()
    ID_entry = tk.Entry(locomotive_window)
    ID_entry.pack()
...
#Il numro dei colori all'interno del vettore deve essere almeno pari al numero di locomoitive massime del sistema, senno errore
    ...
    max_loco_entry = tk.Entry(locomotive_window,width=10)
...
#Il numro dei colori all'interno del vettore deve essere almeno pari al numero di locomoitive massime del sistema, senno errore
    ...
    SO_button = ttk.Menubutton(locomotive_window,text="windows",width=8)
...
def RFID_window(locomotive_window,algo,circuit_window,GUI):
    ...
    def show_page_info():
        ...
        locomotive_window1 = GUI.open_locomotive_window("info", data.Textlines[16], "275x150",locomotive_window)
        if locomotive_window1:
            ...
            label = tk.Label(locomotive_window1, text=info_text)
